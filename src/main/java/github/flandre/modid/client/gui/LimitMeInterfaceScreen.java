...
public class LimitMeInterfaceScreen extends AEBaseScreen<LimitMeInterfaceMenu> {
    private static final ResourceLocation ICONS_TEXTURE = ResourceLocation.parse("ae2_gadgetry:textures/gui/icons.png");
    private static final String MAIN_STYLE = "/screens/ae2_gadgetry/limit_interface.json";
    private static final String CONFIG_STYLE = "/screens/ae2_gadgetry/limit_interface_config.json";
